<template>
<div>
        <link rel="stylesheet" id="theme" v-bind:href="chosenTheme == 'green' ? './green.css' : './red.css'">
        <input type="radio" name="theme_r" value="green" v-on:click="choseTheme('green')">Green<br>
        <input type="radio" name="theme_r" value="green" v-on:click="choseTheme('red')">Red
